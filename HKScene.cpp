...
bool HKScene::init()
{
    ...
    do
    {
        ...
        //地图csb
        m_mapNode = CSLoader::createNode("cocosScene.csb");  //cocosScene.csb
		...
		//_tileMap = TMXTiledMap::create("tx.tmx");
        ...
        //初始坐标
        Point spawnTileCoord(6, 9); //Point spawnTileCoord(6, 9)
...
void HKScene::loadFinish(float i)
{
